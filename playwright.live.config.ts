...
// PILOT_DATA_DIR from a running app). Vite still needs a port Playwright knows up
...
// PILOT_E2E_LIVE_VITE_PORT.
const VITE_PORT = Number(process.env.PILOT_E2E_LIVE_VITE_PORT) || 15273;
