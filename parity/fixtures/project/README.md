...
This is a throwaway project used by the GUI⇄TUI parity harness (see
docs/PARITY-TESTING.md). An agent drives sessions here from both the pilot GUI and the
polytoken TUI. Nothing here is precious — `parity project reset` recreates it.
