...
// (SessionManager.listAll) and warm in-memory sessions not yet written there. A driver
// may only flush a session's .jsonl after its first assistant message, so a just-created
...
// be unit-tested without booting a real driver.
