<script lang="ts">
  ...
  const scripts = ["reply", "reset", "markdown", "search", "thinkingtools", "skill", "confirm", "input", "qna", "answercard", "answerleadup", "ambient", "compat", "bgrun", "bgwait", "queue", "deliverqueue", "discardqueue", "initializing", "editdiff", "editbounds", "editcountguard", "editemptyguards", "editpatch", "images", "error", "idle", "streamhold", "staleidle", "pendinghold", "slowabort", "toolhold", "timeout", "yesno", "journalnudge", "contextfull", "longoutput", "selectmany", "planhandoff", "planhandofftimeout", "planfacet", "planview", "goalactive", "goalclear", "context", "permission", "failnewsession", "failsession", "goal", "unknown", "jobs", "cleantools", "manysessions"];
