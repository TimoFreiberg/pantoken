...
//! with a loud `warning` channel for bad specs. Used by pilot's Settings
...
use pilot_protocol::session_driver::ModelOption;
...
/// one of these or it's a warning. Pilot's Settings DEFAULT_THINKING_LEVELS is
