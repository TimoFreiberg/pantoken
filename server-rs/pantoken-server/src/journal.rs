...
use pantoken_protocol::state::SessionState;
        ...
        events.push(SessionDriverEvent::HostUiRequest {
            ...
            request: HostUiRequest::Widget {
                ...
                placement: Some(match w.placement {
                    pantoken_protocol::state::AmbientPlacement::AboveComposer => {
                        pantoken_protocol::session_driver::WidgetPlacement::AboveComposer
                    }
                    pantoken_protocol::state::AmbientPlacement::BelowComposer => {
                        pantoken_protocol::session_driver::WidgetPlacement::BelowComposer
                    }
                }),
            },
        });
...
mod tests {
    ...
    fn meta_seed_events_preserves_non_item_state() {
        use pantoken_protocol::state::{fold_all, initial_session_state};
        ...
        state
            .pending_approvals
            .push(pantoken_protocol::session_driver::HostUiRequest::Confirm {
                request_id: "r1".into(),
                title: "Confirm?".into(),
                message: "Sure?".into(),
                default_value: None,
